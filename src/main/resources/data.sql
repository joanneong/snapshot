...
('TestUserOne', 'saltedHashPassword', 2);
...
INSERT INTO video_types (id, video_type) VALUES
(1, 'MUSIC');

CREATE TABLE videos (
    video_id VARCHAR(256) PRIMARY KEY NOT NULL,
    title VARCHAR(512) NOT NULL,
    video_type_id INT NOT NULL DEFAULT 1,
    thumbnail_url VARCHAR(512) NOT NULL,
    FOREIGN KEY (video_type_id) REFERENCES video_types (id) ON DELETE CASCADE
);

INSERT INTO videos (video_id, title, video_type_id, thumbnail_url) VALUES
('PVjiKRfKpPI', 'Hozier - Take Me To Church (Official Video)', 1, 'https://i.ytimg.com/vi/PVjiKRfKpPI/mqdefault.jpg'),
('1nnRC6jDOCI', 'Hozier - Take Me To Church (Pop-Up Show in NYC Subway)', 1, 'https://i.ytimg.com/vi/1nnRC6jDOCI/mqdefault.jpg'),
('l2UiY2wivTs', 'Lemon Tree - Fools Garden (Lyrics) 🎵', 1, 'https://i.ytimg.com/vi/l2UiY2wivTs/mqdefault.jpg'),
('bCDIt50hRDs', 'Fool&#39;s Garden - Lemon Tree', 1, 'https://i.ytimg.com/vi/bCDIt50hRDs/mqdefault.jpg'),
('HfdEk5RbzrA', '蘇慧倫 Tarcy Su【Lemon Tree】Official Music Video', 1, 'https://i.ytimg.com/vi/HfdEk5RbzrA/mqdefault.jpg'),
('w0AOGeqOnFY', 'The Coconut Song - (Da Coconut Nut)', 1, 'https://i.ytimg.com/vi/w0AOGeqOnFY/mqdefault.jpg'),
('h1kWMX0qrOY', 'The coconut song, but Among us', 1, 'https://i.ytimg.com/vi/h1kWMX0qrOY/mqdefault.jpg');
...
(1.0, 'Did not even watch it', 'As expressed in the title', TIMESTAMP '1997-01-01 00:00:01', TIMESTAMP '1998-01-01 00:00:01', 1, 'PVjiKRfKpPI'),
(2.0, 'Too much noise!!', 'There is too much noise in the video. Worst music video ever. How did it even get added to YouTube??', TIMESTAMP '1970-01-01 00:00:01', TIMESTAMP '1970-01-01 00:00:01', 1, '1nnRC6jDOCI'),
